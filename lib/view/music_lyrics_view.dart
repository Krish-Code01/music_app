import 'package:MusicLyrics/bloc/music_details_bloc.dart';
import 'package:MusicLyrics/bloc/music_lyrics_bloc.dart';
import 'package:MusicLyrics/models/music_details.dart';
import 'package:MusicLyrics/models/music_lyrics.dart';
import 'package:MusicLyrics/provider/response.dart';
import 'package:MusicLyrics/view/music_list_view.dart';
import 'package:flutter/material.dart';
import 'package:MusicLyrics/bloc/connectivity_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<ConnectivityResult>(
          stream: _netBloc.finalStream.asBroadcastStream(),
